...
if option == "Filter Data" and st.session_state.fetch_completed:
    ...
    if st.session_state.original_data is not None:
        ...
        with st.expander("Filter Options", expanded=st.session_state.expander_open):
            ...
            star_rating_0 = st.checkbox('0 stars')
            star_rating_0_1 = st.checkbox('0 to 1 stars')
            ...
            if st.button('Filter'):
                ...
                star_conditions = []
                if star_rating_0:
                    star_conditions.append("star_rating = 0")
                if star_rating_0_1:
                    star_conditions.append("star_rating > 0 AND star_rating < 1")
                if star_rating_1_2:
